...
## Logi Battery Widget (macOS Sonoma)

This project has been pared down to a minimal macOS app + widget that reads Logi Options+ battery data from:

`~/Library/Application Support/LogiOptionsPlus/settings.db`

and writes a snapshot to an App Group container for the widget.
